...
input <- c(
  "input/cru_origin.txt",
  "input/jel_origin.txt",
  "input/oth_origin.txt"
  
  
)

output <- c(
  "output/cru_origin.txt",
  "output/jel_origin.txt",
  "output/oth_origin.txt"
