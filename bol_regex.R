...
myco_data <- read_tsv("input/oth_origin.txt", col_names = FALSE)
...
spread_df <- spread(myco_table %>% select(-internal_variable_num), term, content)
 ...
 write.csv(spread_df, "output/oth_table.csv")
